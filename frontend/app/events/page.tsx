    ...
    <main data-screen-label="Events" className="kbk-page-main">
      ...
      <div style={{ display: "flex", alignItems: "baseline", gap: 14, flexWrap: "wrap", paddingTop: 44, marginBottom: 4 }}>
        ...
        <span style={{ fontSize: 12, opacity: 0.55 }}>
          {eventCount} upcoming {eventCount === 1 ? "release" : "releases"} · CPI · FOMC · jobs
        </span>
      </div>
      ...
      <footer className="kbk-footer">
        ...
        <span className="kbk-footer-right" style={{ fontFamily: "var(--font-mono)", fontSize: 10.5, opacity: 0.4 }}>times shown in exchange-local · data delayed</span>
      </footer>
    </main>
  );
}
